 ...
 * @author Giuseppe
 */
public class Medikit extends Sprite
{
    public  World mondo;
    public  Body b2Corpo;
    
    private int viteRigenerate;
    
    private  boolean daEliminare;
    private  boolean eliminato;
    private TextureRegion medikit;
    
    public Medikit(World mondo, Gioco gioco, float x)
    {
        ...
        super(gioco.atlas.findRegion("medikit", -1));
        ...
        medikit = new TextureRegion(getTexture(), 745, 145, 50, 50);
    ...
    //parametro x per la posizione random del medikit
    private void creaMedikit(float x)
    {
    ...
    public int getViteRigenerate()
    {
        return viteRigenerate;
    }
    ...
    //l'update si limita ad aggiornare la texture del medikit
